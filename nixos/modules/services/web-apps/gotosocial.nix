...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.gotosocial = {
      ...
      after = [ "network-online.target" ] ++ lib.optional cfg.setupPostgresqlDB "postgresql.target";
      requires = [ "network-online.target" ] ++ lib.optional cfg.setupPostgresqlDB "postgresql.target";
